...
<body>
	...
	<div id="wrap">
		...
		<div class="container">
			...
			<%
							...
							Users users = DBUtils.doUQ(request.getParameter("uId"));
							if(users!=null){
						%>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr height="80px">
							...
							<td><button class="but" type="submit" onClick="check()">确认修改</button>&nbsp;&nbsp;<input type="button" value="订单详情" onclick="javascrtpt:window.location.href='Orders.html?uId=<%=users.getuId()%>'"></td>
						</tr>
					<%
                  }
      		%>
	...
	<div id="footer">
		<div class="container">
			<p class="text-muted credit">用户所有信息</p>
		</div>
	</div>
